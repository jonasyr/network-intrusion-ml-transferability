...
\usepackage[activate={true,nocompatibility},final,tracking=true,factor=1100,stretch=10,shrink=10]{microtype} % Mikrotypografie für LuaLaTeX
...
% Ragged2e für späteren Blocksatz
\usepackage{ragged2e}
...
%    \clearpage
    ...
    % BLOCKSATZ SOFORT AKTIVIEREN
    \let\raggedright\relax
    \let\centering\relax  
    \let\raggedleft\relax
