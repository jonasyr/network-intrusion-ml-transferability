...
%    \clearpage
    ...
    \begin{figure}[H]
        ...
        (a) Best F1-Score per Dataset mit Top-Modell pro Konfiguration,
        (b) Model Consistency Across Datasets (Variationskoeffizient, niedriger = konsistenter),
        (c) F1-Score Distribution by Dataset mit Baseline/Advanced Boxplots,
        (d) Average Model Ranking über alle Metriken (niedriger = besser),
        (e) Performance vs Speed Trade-off Scatter-Plot (F1 vs. Prediction Time),
        (f) Dataset Performance Summary mit Mean/Best/Worst F1-Scores.}
        \source{Eigene Darstellung.}
